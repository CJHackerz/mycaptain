...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { content: @contribution.content, title: @contribution.title, user_id: @contribution.user_id, workshop_id: @contribution.workshop_id }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { content: @contribution.content, title: @contribution.title, user_id: @contribution.user_id, workshop_id: @contribution.workshop_id }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
